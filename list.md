...
31. Use DLSS(or equivalent technology) with "GeForce Now"(or other cloud gaming service) to upscale the game stream, it would lower the bandwidth requirements.
