...
If the game would be a ascii roguelike game, the output could be directly the level itself, every character from the output could represent a part of the level, one character woukd represent an enemy, another character would represent and item, and another one the game character, the wall, etc.
