...
30. Differentiable NARS/OpenNARS. It could be written in python with the pytorch library and would/could be GPU/TPU accelerated. It could be trained(with backpropagation/autodiff) to learn new rules.
